...
public class GUIjp extends JFrame {

	 
    private JFrame frame = new JFrame("AR¥Þ¥Í©`¥×¥í¥¸¥§¥¯¥È");
	...
	void mainPage(){
		...
		JLabel lblWeclome = new JLabel("AR\u30DE\u30CD\u30FC\u3078\u3088\u3046\u3053\u305D");
		lblWeclome.setFont(new Font("MS Mincho", Font.BOLD, 48));
		...
		btnLanguage.setFont(new Font("Times New Roman", Font.BOLD, 18));
		...
		JButton btnCharge = new JButton("\u30C1\u30E3\u30FC\u30B8");
		btnCharge.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					cl.show(contentPane, "charge");
			}
		});
		btnCharge.setFont(new Font("MS Mincho", Font.BOLD, 36));
		...
		JButton btnPurchase = new JButton("\u3054\u8CFC\u5165");
		btnPurchase.setFont(new Font("MS Mincho", Font.BOLD, 36));
		...
		JButton btnBalance = new JButton("\u6B8B\u9AD8\u7167\u4F1A");
		btnBalance.setFont(new Font("MS Mincho", Font.BOLD, 36));
		...
		JLabel lblInfo = new JLabel("<html><p align =\"right\">I-CARE\u30B0\u30EB\u30FC\u30D7<br>\u7B51\u6CE2\u5927\u5B66</p></html>");
		lblInfo.setHorizontalAlignment(SwingConstants.RIGHT);
		lblInfo.setFont(new Font("MS Mincho", Font.BOLD, 12));
	...
	void chargePage(){
		...
		JLabel lblInfo = new JLabel("¥Á¥ã©`¥¸½ðî~¤òßx¤ó¤Ç¤¯¤À¤µ¤¤");
		lblInfo.setFont(new Font("MS Mincho", Font.BOLD, 48));
		...
		JButton btn500yen = new JButton("500ƒÒ");
		btn500yen.setFont(new Font("MS Mincho", Font.BOLD, 24));
		...
		JButton btn1000yen = new JButton("1000ƒÒ");
		btn1000yen.setFont(new Font("MS Mincho", Font.BOLD, 24));
		...
		JButton btn2000yen = new JButton("2000ƒÒ");
		btn2000yen.setFont(new Font("MS Mincho", Font.BOLD, 24));
		...
		JButton btn3000yen = new JButton("3000ƒÒ");
		btn3000yen.setFont(new Font("MS Mincho", Font.BOLD, 24));
		...
		JButton btn4000yen = new JButton("4000ƒÒ");
		btn4000yen.setFont(new Font("MS Mincho", Font.BOLD, 24));
		...
		JButton btn5000yen = new JButton("5000ƒÒ");
		btn5000yen.setFont(new Font("MS Mincho", Font.BOLD, 24));
		...
		JButton btnReturn = new JButton("¥á¥Ë¥å©`¤Ø‘ø¤ë");
		btnReturn.setFont(new Font("MS Mincho", Font.BOLD, 18));
